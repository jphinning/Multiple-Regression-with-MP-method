...
def complex_plane2(z, axis_type=0, file_name='file.png'):
    ...
    plt.xlim(-w, w)
    plt.ylim(-w, w)
    plt.arrow(0, -w, 0, 1.9*w, head_width=w/20,
              head_length=w/20, fc='k', ec='k')
    plt.arrow(-w, 0, 1.9*w, 0, head_width=w/20,
              head_length=w/20, fc='k', ec='k')
    ...
    for i in range(len(z)):
        ...
        plt.arrow(0, 0, x, y, head_width=w/20,
                  head_length=w/20, fc='b', ec='b')
